	...
	config = function()
		...
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(event)
				...
				-- Add missing imports / organize imports in one keypress, no menu.
				-- Works for both gopls (source.organizeImports) and ts_ls
				-- (source.addMissingImports.ts / source.organizeImports.ts).
